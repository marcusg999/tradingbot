...
def test_enter_creates_protected_position(engine):
    notional = engine.enter("BTC/USD", 100.0, 10_000.0, 0.0, 10.0, "reason")
...
def test_trailing_stop_raise(engine):
    engine.enter("BTC/USD", 100.0, 10_000.0, 0.0, 10.0, "reason")
...
def test_stop_gap_forces_exit(engine):
    engine.enter("SOL/USD", 100.0, 10_000.0, 0.0, 10.0, "reason")
